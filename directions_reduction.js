...
and not much water, it's important to save yourself some energy, 
...
are not directly opposite of each other and can't become such. Hence 
...
function dirReduc(arr) {
    ...
    for (let direction of arr) {
        const oppositeDirection = opposite[direction.toUpperCase()];

        if (stack.length && stack[stack.length - 1].toUpperCase() === oppositeDirection) {
            stack.pop();
        } else {
...
console.log(dirReduc(["NORTH", "EAST", "WEST", "SOUTH"]));
console.log(dirReduc(["NORTH", "SOUTH", "SOUTH", "EAST", "WEST"]));
console.log(dirReduc(["NORTH", "EAST", "WEST", "SOUTH", "WEST", "WEST"]));
console.log(dirReduc(["NoRtH", "SoUtH", "SoUtH", "eAsT", "wEsT", "NORTH", "west"]));
console.log(dirReduc(["NORTH", "SOUTH", "EAST", "WEST", "NORTH", "EAST", "WEST", "SOUTH", "NORTH", "EAST", "WEST", "SOUTH"]));
console.log(dirReduc(["NORTH", "south", "West", "East", "wEST", "NoRTh", "sOuTH", "eAsT", "WEST", "NORTH"]));
